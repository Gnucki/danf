...
/**
 * Expose `StringPathResolver`.
 */
module.exports = StringPathResolver;

/**
 * Initialize a new string path resolver.
 */
function StringPathResolver() {
}

/**
 * @interface {danf:manipulation.stringPathResolver}
 */
StringPathResolver.prototype.resolve = function(path, context, separator) {
    separator = separator || '.';
