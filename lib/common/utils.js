...
var utils = {
        ...
        if (extended && extender) {
            if (typeof extended === 'function' && typeof extender === 'function') {
                var prototype = extender.prototype,
                    extendedPrototype = Object.create(extended.prototype),
                    prototypeDescriptor = Object.getOwnPropertyDescriptor(extender, 'prototype')
                ;

                if (prototypeDescriptor.writable) {
                    extender.prototype = extendedPrototype;
                } else {
                    if (Object.setPrototypeOf) {
                        Object.setPrototypeOf(extender.prototype, extendedPrototype);
                    } else {
                        extender.prototype.__proto__ = extendedPrototype;
                    }
                }
     ...
     * @param {number|null} length The string max length.
     * @return {string} The stringified object.
     * @api public
     */
    stringify: function(object, length) {
        var string;
